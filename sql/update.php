<?php
	...
	if(isset($_POST["edit_user"])){
		...
		$ed_user = "UPDATE nomeBancoDados.users SET  email='".$_POST["email"]."', formacao='".$_POST["formacao"]."', name='".$_POST["name"]."', sobrenome='".$_POST["sobrenome"]."', password='".$senha."' WHERE (users.id_usuario = '".$_POST["user"]."')";
	...
	if(isset($_POST["form_ed_perfil"])){
		$ed_perfil = "UPDATE nomeBancoDados.cadastro SET telefone='".$_POST["celular"]."', endereco='".$_POST["endereco"]."', numero='".$_POST["numero"]."',  complemento='".$_POST["complemento"]."', bairro='".$_POST["bairro"]."', cidade='".$_POST["cidade"]."', estado='".$_POST["estado"]."', pais='".$_POST["pais"]."',  cep='".$_POST["cep"]."' WHERE (cadastro.fk_usuario = '".$_POST["usuario"]."')";
