...
if(isset($_GET['resposta'])!='' && isset($_GET['class'])!=''){			
	...
	$class_resposta = "UPDATE u347189519_verdu.resposta_verifica SET class_resposta ='".$nivel."' WHERE pk_id_resposta = '".$id_resposta."'";
		...
		<div id="respostas">
			...
			<h5>
                <big>
                    ...
                    <?php $resposta = $row_RsRespostas['pk_id_resposta'];	} ?>
			<?php                 
